...
const animLayout = {
  ...
  animate: {
    x: 0,
    opacity: 1,
    transition: { ease: easing, duration: 0.6, delay: 0.8 },
  },
};
      ...
      <Layout fixedHeader>
        ...
        >
          ...
          <Navigation className="app-bar-navigation">
            ...
            <Link
              ...
              onClick={() => location.push('/resume')}
            >
              {t('navbar.links.resume')}
            </Link>
            <Link
              style={{
                color: location.pathname == '/' ? '#fff' : '#000',
        ...
        <Drawer
          title={
            <Link
              onClick={() => location.push('/')}
              style={{ textDecoration: 'none', color: 'black', marginLeft: 20 }}
            >
              {t('my_portfolio')}
            </Link>
          }
