...
export default function index() {
  const { t } = useTranslation("landing", "projects");
  return (
    <MainLayout>
      ...
      <div className="landing-grid">
        ...
        <div className="landing-skills">
          ...
          <div style={{ marginTop: 30 }}>
            <WaveButton label={t("view-all-skills")} path="/resume" />
          </div>
        </div>
        <LandingProject />
        <div className="last-section-landing">
          <div className="landing-last-experience">
            ...
            <div className="last-experience">
              ...
              <img
                src={lastExperience.logo}
                width={100}
                heigh={100}
                style={{ float: "left", marginTop: -5 }}
              />
              <p className="description">{t(lastExperience.description)}</p>
            ...
            <div>
              <WaveButton label={t("view-all-experiences")} path="/resume" />
            </div>
          </div>
        </div>
      </div>
